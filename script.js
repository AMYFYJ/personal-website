...
// Console Easter Egg
console.log('%c👋 Welcome to Amy Fang\'s Portfolio!', 'font-size: 20px; font-weight: bold; color: #00f5ff;');
console.log('%cLooking for something? Feel free to reach out!', 'font-size: 14px; color: #667eea;');
console.log('%cBuilt with ❤️ using HTML, CSS, and JavaScript', 'font-size: 12px; color: #a0a0b0;');
